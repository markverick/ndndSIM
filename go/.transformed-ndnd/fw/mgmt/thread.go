...
func MakeMgmtThread() *Thread {
	...
	m.registerModule("strategy-choice", NewStrategyChoiceModule(strategyChoiceUnicast))
	m.registerModule("multicast-strategy-choice", NewStrategyChoiceModule(strategyChoiceMulticast))
